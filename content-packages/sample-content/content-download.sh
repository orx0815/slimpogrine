...
curl -u admin:admin 'http://localhost:8080/bin/cpm/package.download.zip/motorbrot-samples/slimpogrine-sample-content-1.0-SNAPSHOT.zip' --output slimpogrine-sample-content-1.0-SNAPSHOT.zip
unzip -o slimpogrine-sample-content-1.0-SNAPSHOT.zip
rm slimpogrine-sample-content-1.0-SNAPSHOT.zip
