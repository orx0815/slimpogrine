...
# echo "Download not support for Composum yet with wcmio-content-package:download. Using curl. You need to manually rebuild package in http://localhost:8080/bin/packages.html/motorbrot-samples/slimpogrine-sample-content-slimpo-1.0-SNAPSHOT.zip"
