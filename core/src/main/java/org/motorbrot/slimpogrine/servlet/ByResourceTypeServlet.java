 ...
 * <p>
 * This servlet binds to the <code>sling/servlet/default</code> resource type,
 * which means that it is registered for all resources. The registration is
 * narrowed down by the selectors and extensions.
 * </p>
 * <p>
 * Assuming the sample content is installed, it will serve requests of the form
 * <code>GET /${resource}.hello.html</code>
 * </p>
...
public class ByResourceTypeServlet extends SlingSafeMethodsServlet {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ByResourceTypeServlet.class);
